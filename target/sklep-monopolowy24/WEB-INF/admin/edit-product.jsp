            ...
            <form method="post" action="${pageContext.request.contextPath}/admin/product-manager/edit-product">
                <div class="input-row">
                    ...
                    <p class="input-element"><span>Nazwa produktu:</span> <br /> <span style="font-size: 8px">Nazwa produktu musi zawierać minimum 3 znaki.</span> <br />
                        <input type="text" name="product_name" pattern=".{3,}" value="<% out.println(singleProduct.getProduct_name()); %>" title="Nazwa produktu musi zawierać minimum 3 znaki" required></p></div>
                <div class="input-row">
                ...
                <div class="input-row">
                    ...
                    <p class="input-element"><span>Czy na wyprzedaży:</span> <br /> <input type="text" name="sale_price" value="<% out.println(singleProduct.getSale_price()); %>" required></p>
                </div>
                <div class="input-row">
